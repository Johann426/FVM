    ...
    DOUBLE PRECISION, ALLOCATABLE :: UU_AVG(:,:,:),UV_AVG(:,:,:),UW_AVG(:,:,:)
    DOUBLE PRECISION, ALLOCATABLE :: VV_AVG(:,:,:),VW_AVG(:,:,:)
    DOUBLE PRECISION, ALLOCATABLE :: WW_AVG(:,:,:)
    ...
    DOUBLE PRECISION, ALLOCATABLE	:: SGS11(:,:,:),SGS12(:,:,:),SGS13(:,:,:)
    DOUBLE PRECISION, ALLOCATABLE	:: SGS22(:,:,:),SGS23(:,:,:)
    DOUBLE PRECISION, ALLOCATABLE	:: SGS33(:,:,:)
