	...
	DO I=IS,IE
        ...
        IF (DJAC(I,J,K).LT.1.0E-15) WRITE(6,*) I,J,K,'DJAC=',DJAC(I,J,K)
	ENDDO
	ENDDO
	ENDDO
	...
	DO I=IS1,IE1
        ...
        DT(I,J,K)=0.5D0*(DJAC(I,J,K)*Q33(I,J,K)+DJAC(I,J,K+1)*Q33(I,J,K+1))
		DB(I,J,K)=0.5D0*(DJAC(I,J,K)*Q33(I,J,K)+DJAC(I,J,K-1)*Q33(I,J,K-1))
    ENDDO
	ENDDO
	ENDDO
...
!	WRITE(100+RANK,*) 'variables=x,y,z,J^-1,,Q11,Q22,Q33,Q23,Q31,Q12'
!	WRITE(100+RANK,54) IE-IS+1,JE-JS+1,KE-KS+1
!54	FORMAT(TR1'ZONE T="WHOLE", I=',I6,', J=',I6,', K=',I6)
!	DO K=KS,KE
!	DO J=JS,JE
!	DO I=IS,IE
!		WRITE(100+RANK,*) X(I,J,K),Y(I,J,K),Z(I,J,K),DJAC(I,J,K),Q11(I,J,K),Q22(I,J,K),Q33(I,J,K),Q23(I,J,K),Q31(I,J,K),Q12(I,J,K)
!	ENDDO
!	ENDDO
!	ENDDO
!	CLOSE(100+RANK)
