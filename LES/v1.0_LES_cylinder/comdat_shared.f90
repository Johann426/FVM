...
!	DOUBLE PRECISION, ALLOCATABLE :: T_TA(:,:,:)
	...
	DOUBLE PRECISION, ALLOCATABLE  :: LSS11_hat(:,:,:),LSS12_hat(:,:,:),LSS13_hat(:,:,:)
	DOUBLE PRECISION, ALLOCATABLE  :: LSS21_hat(:,:,:),LSS22_hat(:,:,:),LSS23_hat(:,:,:)
	DOUBLE PRECISION, ALLOCATABLE  :: LSS31_hat(:,:,:),LSS32_hat(:,:,:),LSS33_hat(:,:,:)
