...
!						+W(I,J,K-1)+W(I,J-1,K-1)+W(I-1,J,K-1)+W(I-1,J-1,K-1))
	...
	WRITE(1000+RANK,*) 'variables=x,y,z,vorM,lamda,T'
    WRITE(1000+RANK,136) IE-IS,JE-JS,KE-KS,RTIME
136  FORMAT(TR1,'ZONE T="WHOLE", I=',I6,', j=',I6,', k=',I6,', SOLUTIONTIME=',F10.4)
	DO K=KS1,KE
    DO J=JS1,JE
    DO I=IS1,IE
		WRITE(1000+RANK,141) XG(I,J,K),YG(I,J,K),ZG(I,J,K),DUM_3D(I,J,K),LAMDAG(I,J,K),TG(I,J,K)
141		FORMAT(TR1,D16.9,TR1,D16.9,TR1,D16.9,TR1,D16.9,TR1,D16.9,TR1,D16.9)
	ENDDO
	ENDDO
	ENDDO
	CLOSE(1000+RANK)
