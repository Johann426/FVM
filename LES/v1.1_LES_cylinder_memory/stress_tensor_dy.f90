	...
	DOUBLE PRECISION :: CS,MAX_CS2,MIN_CS2
...
!------------------------------------------------------------
	...
	L_IJ(IS1:IE1,JS1:JE1,KS1:KE1)   =	&
		DUM_OUT(IS1:IE1,JS1:JE1,KS1:KE1) - U_HAT(IS1:IE1,JS1:JE1,KS1:KE1)*V_HAT(IS1:IE1,JS1:JE1,KS1:KE1)
...
!------------------------------------------------------------
	...
	L_IJ(IS1:IE1,JS1:JE1,KS1:KE1)   =	&
			DUM_OUT(IS1:IE1,JS1:JE1,KS1:KE1) - U_HAT(IS1:IE1,JS1:JE1,KS1:KE1)*W_HAT(IS1:IE1,JS1:JE1,KS1:KE1)
...
!------------------------------------------------------------
	...
	L_IJ(IS1:IE1,JS1:JE1,KS1:KE1)   =	&
			DUM_OUT(IS1:IE1,JS1:JE1,KS1:KE1) - V_HAT(IS1:IE1,JS1:JE1,KS1:KE1)*W_HAT(IS1:IE1,JS1:JE1,KS1:KE1)
...
!------------------------------------------------------------
	...
	DO J = JS1,JE1
	DO I = IS1,IE1
		CS=-0.5D0 * LM_IJ(I,J,K)/MM_IJ(I,J,K)
		MAX_CS2 = MAX(MAX_CS2,CS)
		MIN_CS2 = MIN(MIN_CS2,CS)
	...
	IF(T_MM_AVG.NE.0.D0)	C_AVG = -0.5D0 * T_LM_AVG/T_MM_AVG
	
	IF(RANK.EQ.0) THEN
		OPEN(UNIT=12,FILE='Cs.PLT',STATUS='OLD',ACCESS='APPEND')
		WRITE(12,*) RTIME,C_AVG,MAX_CS2,MIN_CS2
		CLOSE(12)
	ENDIF
