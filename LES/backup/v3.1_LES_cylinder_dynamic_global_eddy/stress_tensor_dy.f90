	...
	DOUBLE PRECISION :: NOM_AVG
	DOUBLE PRECISION :: DEN_AVG
...
!	B32=WID1(I,J,K)**2 * A13(I,J,K)*A12(I,J,K) + WID2(I,J,K)**2 * A23(I,J,K)*A22(I,J,K) + WID3(I,J,K)**2 * A33(I,J,K)*A32(I,J,K)
	...
	IF(DUM.EQ.0.D0) PHIG(I,J,K) = 0.D0
	...
	DUDX=0.5D0*(XIX(I,J,K)*2.D0*(U(I+1,J,K)-U(I,J,K))+ETX(I,J,K)*(U(I,J+1,K)-U(I,J-1,K))+ZTX(I,J,K)*(U(I,J,K+1)-U(I,J,K-1)))
	DVDX=0.5D0*(XIX(I,J,K)*2.D0*(V(I+1,J,K)-V(I,J,K))+ETX(I,J,K)*(V(I,J+1,K)-V(I,J-1,K))+ZTX(I,J,K)*(V(I,J,K+1)-V(I,J,K-1)))
	DWDX=0.5D0*(XIX(I,J,K)*2.D0*(W(I+1,J,K)-W(I,J,K))+ETX(I,J,K)*(W(I,J+1,K)-W(I,J-1,K))+ZTX(I,J,K)*(W(I,J,K+1)-W(I,J,K-1)))
	
	DUDY=0.5D0*(XIY(I,J,K)*2.D0*(U(I+1,J,K)-U(I,J,K))+ETY(I,J,K)*(U(I,J+1,K)-U(I,J-1,K))+ZTY(I,J,K)*(U(I,J,K+1)-U(I,J,K-1)))
	DVDY=0.5D0*(XIY(I,J,K)*2.D0*(V(I+1,J,K)-V(I,J,K))+ETY(I,J,K)*(V(I,J+1,K)-V(I,J-1,K))+ZTY(I,J,K)*(V(I,J,K+1)-V(I,J,K-1)))
	DWDY=0.5D0*(XIY(I,J,K)*2.D0*(W(I+1,J,K)-W(I,J,K))+ETY(I,J,K)*(W(I,J+1,K)-W(I,J-1,K))+ZTY(I,J,K)*(W(I,J,K+1)-W(I,J,K-1)))
	
	DUDZ=0.5D0*(XIZ(I,J,K)*2.D0*(U(I+1,J,K)-U(I,J,K))+ETZ(I,J,K)*(U(I,J+1,K)-U(I,J-1,K))+ZTZ(I,J,K)*(U(I,J,K+1)-U(I,J,K-1)))
	DVDZ=0.5D0*(XIZ(I,J,K)*2.D0*(V(I+1,J,K)-V(I,J,K))+ETZ(I,J,K)*(V(I,J+1,K)-V(I,J-1,K))+ZTZ(I,J,K)*(V(I,J,K+1)-V(I,J,K-1)))
	DWDZ=0.5D0*(XIZ(I,J,K)*2.D0*(W(I+1,J,K)-W(I,J,K))+ETZ(I,J,K)*(W(I,J+1,K)-W(I,J-1,K))+ZTZ(I,J,K)*(W(I,J,K+1)-W(I,J,K-1)))
...
!	S32(I,J,K)=0.5D0*DWDY + 0.5D0*DVDZ
	...
	DUDX=0.5D0*(XIX(I,J,K)*2.D0*(U(I,J,K)-U(I-1,J,K))+ETX(I,J,K)*(U(I,J+1,K)-U(I,J-1,K))+ZTX(I,J,K)*(U(I,J,K+1)-U(I,J,K-1)))
	DVDX=0.5D0*(XIX(I,J,K)*2.D0*(V(I,J,K)-V(I-1,J,K))+ETX(I,J,K)*(V(I,J+1,K)-V(I,J-1,K))+ZTX(I,J,K)*(V(I,J,K+1)-V(I,J,K-1)))
	DWDX=0.5D0*(XIX(I,J,K)*2.D0*(W(I,J,K)-W(I-1,J,K))+ETX(I,J,K)*(W(I,J+1,K)-W(I,J-1,K))+ZTX(I,J,K)*(W(I,J,K+1)-W(I,J,K-1)))
	
	DUDY=0.5D0*(XIY(I,J,K)*2.D0*(U(I,J,K)-U(I-1,J,K))+ETY(I,J,K)*(U(I,J+1,K)-U(I,J-1,K))+ZTY(I,J,K)*(U(I,J,K+1)-U(I,J,K-1)))
	DVDY=0.5D0*(XIY(I,J,K)*2.D0*(V(I,J,K)-V(I-1,J,K))+ETY(I,J,K)*(V(I,J+1,K)-V(I,J-1,K))+ZTY(I,J,K)*(V(I,J,K+1)-V(I,J,K-1)))
	DWDY=0.5D0*(XIY(I,J,K)*2.D0*(W(I,J,K)-W(I-1,J,K))+ETY(I,J,K)*(W(I,J+1,K)-W(I,J-1,K))+ZTY(I,J,K)*(W(I,J,K+1)-W(I,J,K-1)))
	
	DUDZ=0.5D0*(XIZ(I,J,K)*2.D0*(U(I,J,K)-U(I-1,J,K))+ETZ(I,J,K)*(U(I,J+1,K)-U(I,J-1,K))+ZTZ(I,J,K)*(U(I,J,K+1)-U(I,J,K-1)))
	DVDZ=0.5D0*(XIZ(I,J,K)*2.D0*(V(I,J,K)-V(I-1,J,K))+ETZ(I,J,K)*(V(I,J+1,K)-V(I,J-1,K))+ZTZ(I,J,K)*(V(I,J,K+1)-V(I,J,K-1)))
	DWDZ=0.5D0*(XIZ(I,J,K)*2.D0*(W(I,J,K)-W(I-1,J,K))+ETZ(I,J,K)*(W(I,J+1,K)-W(I,J-1,K))+ZTZ(I,J,K)*(W(I,J,K+1)-W(I,J,K-1)))
...
!	B32=WID1(I,J,K)**2 * A13A(I,J,K)*A12A(I,J,K) + WID2(I,J,K)**2 * A23A(I,J,K)*A22A(I,J,K) + WID3(I,J,K)**2 * A33A(I,J,K)*A32A(I,J,K)
	...
	IF(DUM.EQ.0.D0) PHIA(I,J,K) = 0.D0
	...
	!	COMPUTE	11
	DUM_IN(IS:IE,JS:JE,KS:KE)	=A11(IS:IE,JS:JE,KS:KE)**2
	CALL TEST_FILTER(DUM_IN,DUM_3D)
	A_IJ_A_IJ(IS1:IE1,JS1:JE1,KS1:KE1)	=DUM_3D(IS1:IE1,JS1:JE1,KS1:KE1)-A11A(IS1:IE1,JS1:JE1,KS1:KE1)**2
	
	DUM_IN(IS:IE,JS:JE,KS:KE)	=PHIG(IS1:IE1,JS1:JE1,KS1:KE1)*S11(IS:IE,JS:JE,KS:KE)**2
	CALL TEST_FILTER(DUM_IN,DUM_3D)
	S_IJ_S_IJ(IS1:IE1,JS1:JE1,KS1:KE1)	=DUM_3D(IS1:IE1,JS1:JE1,KS1:KE1)	&
										-PHIA(IS1:IE1,JS1:JE1,KS1:KE1)*S11A(IS1:IE1,JS1:JE1,KS1:KE1)**2

	!	COMPUTE	12
	DUM_IN(IS:IE,JS:JE,KS:KE)	=A12(IS:IE,JS:JE,KS:KE)**2
	CALL TEST_FILTER(DUM_IN,DUM_3D)
	A_IJ_A_IJ(IS1:IE1,JS1:JE1,KS1:KE1) = A_IJ_A_IJ(IS1:IE1,JS1:JE1,KS1:KE1)	&
										+DUM_3D(IS1:IE1,JS1:JE1,KS1:KE1)-A12A(IS1:IE1,JS1:JE1,KS1:KE1)**2
	
	DUM_IN(IS:IE,JS:JE,KS:KE)	=PHIG(IS1:IE1,JS1:JE1,KS1:KE1)*S12(IS:IE,JS:JE,KS:KE)**2
	CALL TEST_FILTER(DUM_IN,DUM_3D)
	S_IJ_S_IJ(IS1:IE1,JS1:JE1,KS1:KE1) = S_IJ_S_IJ(IS1:IE1,JS1:JE1,KS1:KE1)+DUM_3D(IS1:IE1,JS1:JE1,KS1:KE1)	&
										-PHIA(IS1:IE1,JS1:JE1,KS1:KE1)*S12A(IS1:IE1,JS1:JE1,KS1:KE1)**2
	
	!	COMPUTE	13
	DUM_IN(IS:IE,JS:JE,KS:KE)	=A13(IS:IE,JS:JE,KS:KE)**2
	CALL TEST_FILTER(DUM_IN,DUM_3D)
	A_IJ_A_IJ(IS1:IE1,JS1:JE1,KS1:KE1) = A_IJ_A_IJ(IS1:IE1,JS1:JE1,KS1:KE1)	&
										+2.D0*DUM_3D(IS1:IE1,JS1:JE1,KS1:KE1)-2.D0*A13A(IS1:IE1,JS1:JE1,KS1:KE1)**2
	
	DUM_IN(IS:IE,JS:JE,KS:KE)	=PHIG(IS1:IE1,JS1:JE1,KS1:KE1)*S13(IS:IE,JS:JE,KS:KE)**2
	CALL TEST_FILTER(DUM_IN,DUM_3D)
	S_IJ_S_IJ(IS1:IE1,JS1:JE1,KS1:KE1) = S_IJ_S_IJ(IS1:IE1,JS1:JE1,KS1:KE1)+DUM_3D(IS1:IE1,JS1:JE1,KS1:KE1)	&
										-PHIA(IS1:IE1,JS1:JE1,KS1:KE1)*S13A(IS1:IE1,JS1:JE1,KS1:KE1)**2
										
	!	COMPUTE	21
	DUM_IN(IS:IE,JS:JE,KS:KE)	=A21(IS:IE,JS:JE,KS:KE)**2
	CALL TEST_FILTER(DUM_IN,DUM_3D)
	A_IJ_A_IJ(IS1:IE1,JS1:JE1,KS1:KE1) = A_IJ_A_IJ(IS1:IE1,JS1:JE1,KS1:KE1)	&
										+2.D0*DUM_3D(IS1:IE1,JS1:JE1,KS1:KE1)-2.D0*A21A(IS1:IE1,JS1:JE1,KS1:KE1)**2
	...
	!	COMPUTE	22
	DUM_IN(IS:IE,JS:JE,KS:KE)	=A22(IS:IE,JS:JE,KS:KE)**2
	CALL TEST_FILTER(DUM_IN,DUM_3D)
	A_IJ_A_IJ(IS1:IE1,JS1:JE1,KS1:KE1)	=A_IJ_A_IJ(IS1:IE1,JS1:JE1,KS1:KE1) &
										+DUM_3D(IS1:IE1,JS1:JE1,KS1:KE1)-A22A(IS1:IE1,JS1:JE1,KS1:KE1)**2
	
	DUM_IN(IS:IE,JS:JE,KS:KE)	=PHIG(IS1:IE1,JS1:JE1,KS1:KE1)*S22(IS:IE,JS:JE,KS:KE)**2
	CALL TEST_FILTER(DUM_IN,DUM_3D)
	S_IJ_S_IJ(IS1:IE1,JS1:JE1,KS1:KE1)	=S_IJ_S_IJ(IS1:IE1,JS1:JE1,KS1:KE1)+DUM_3D(IS1:IE1,JS1:JE1,KS1:KE1)	&
										-PHIA(IS1:IE1,JS1:JE1,KS1:KE1)*S22A(IS1:IE1,JS1:JE1,KS1:KE1)**2
	
	!	COMPUTE	23
	DUM_IN(IS:IE,JS:JE,KS:KE)	=A23(IS:IE,JS:JE,KS:KE)**2
	CALL TEST_FILTER(DUM_IN,DUM_3D)
	A_IJ_A_IJ(IS1:IE1,JS1:JE1,KS1:KE1) = A_IJ_A_IJ(IS1:IE1,JS1:JE1,KS1:KE1)	&
										+2.D0*DUM_3D(IS1:IE1,JS1:JE1,KS1:KE1)-2.D0*A23A(IS1:IE1,JS1:JE1,KS1:KE1)**2
	
	DUM_IN(IS:IE,JS:JE,KS:KE)	=PHIG(IS1:IE1,JS1:JE1,KS1:KE1)*S23(IS:IE,JS:JE,KS:KE)**2
	CALL TEST_FILTER(DUM_IN,DUM_3D)
	S_IJ_S_IJ(IS1:IE1,JS1:JE1,KS1:KE1) = S_IJ_S_IJ(IS1:IE1,JS1:JE1,KS1:KE1) + 2.D0*DUM_3D(IS1:IE1,JS1:JE1,KS1:KE1)	&
										-2.D0*PHIA(IS1:IE1,JS1:JE1,KS1:KE1)*S23A(IS1:IE1,JS1:JE1,KS1:KE1)**2

	!	COMPUTE	31
	DUM_IN(IS:IE,JS:JE,KS:KE)	=A31(IS:IE,JS:JE,KS:KE)**2
	CALL TEST_FILTER(DUM_IN,DUM_3D)
	A_IJ_A_IJ(IS1:IE1,JS1:JE1,KS1:KE1) = A_IJ_A_IJ(IS1:IE1,JS1:JE1,KS1:KE1)	&
										+2.D0*DUM_3D(IS1:IE1,JS1:JE1,KS1:KE1)-2.D0*A31A(IS1:IE1,JS1:JE1,KS1:KE1)**2
	...
	!	COMPUTE	32
	DUM_IN(IS:IE,JS:JE,KS:KE)	=A32(IS:IE,JS:JE,KS:KE)**2
	CALL TEST_FILTER(DUM_IN,DUM_3D)
	A_IJ_A_IJ(IS1:IE1,JS1:JE1,KS1:KE1) = A_IJ_A_IJ(IS1:IE1,JS1:JE1,KS1:KE1)	&
										+2.D0*DUM_3D(IS1:IE1,JS1:JE1,KS1:KE1)-2.D0*A32A(IS1:IE1,JS1:JE1,KS1:KE1)**2
	...
	!	COMPUTE	33
	DUM_IN(IS:IE,JS:JE,KS:KE)	=A33(IS:IE,JS:JE,KS:KE)**2
	CALL TEST_FILTER(DUM_IN,DUM_3D)
	A_IJ_A_IJ(IS1:IE1,JS1:JE1,KS1:KE1)	=A_IJ_A_IJ(IS1:IE1,JS1:JE1,KS1:KE1)	&
										+DUM_3D(IS1:IE1,JS1:JE1,KS1:KE1)-A33A(IS1:IE1,JS1:JE1,KS1:KE1)**2
	
	DUM_IN(IS:IE,JS:JE,KS:KE)	=PHIG(IS1:IE1,JS1:JE1,KS1:KE1)*S33(IS:IE,JS:JE,KS:KE)**2
	CALL TEST_FILTER(DUM_IN,DUM_3D)
	S_IJ_S_IJ(IS1:IE1,JS1:JE1,KS1:KE1)	=S_IJ_S_IJ(IS1:IE1,JS1:JE1,KS1:KE1)+DUM_3D(IS1:IE1,JS1:JE1,KS1:KE1)	&
	...
	DO J = JS1,JE1
	DO I = IS1,IE1
		NOM_AVG = NOM_AVG + A_IJ_A_IJ(I,J,K)*DJAC(I,J,K)
		DEN_AVG = DEN_AVG + S_IJ_S_IJ(I,J,K)*DJAC(I,J,K)
	ENDDO
	ENDDO
	ENDDO
	
	CALL MPI_ALLREDUCE(NOM_AVG,DUM_A,1,MPI_DOUBLE_PRECISION, MPI_SUM,NMCW,ERR)
	CALL MPI_ALLREDUCE(DEN_AVG,DUM_B,1,MPI_DOUBLE_PRECISION, MPI_SUM,NMCW,ERR)
	
!	NOM_AVG = DUM_A / DUM_C
!	DEN_AVG = DUM_B / DUM_C
	
	NOM_AVG = DUM_A / T_VOLUME
	DEN_AVG = DUM_B / T_VOLUME
	
	CV = NOM_AVG / DEN_AVG
	IF(DEN_AVG.EQ.0.D0) CV = 0.D0
	
	CV = -1.D0/(2.D0*RE)*CV
	
!	IF(NITER_TIME.LT.10) CV = 0.025D0
...
!	AVERAGED VALUE
	...
	EDDY_VISCOS(IS1:IE1,JS1:JE1,KS1:KE1) = CV*PHIG(IS1:IE1,JS1:JE1,KS1:KE1)
