...
176		FORMAT(TR1,D16.9,TR1,D16.9,TR1,D16.9,TR1,D16.9,TR1,I16)
		...
		DO J=JS,JE
		DO I=IS,IE
		    WRITE(16+RANK,182) NLX(I,J,K),NLY(I,J,K),NLZ(I,J,K)
	    	WRITE(16+RANK,183) U(I,J,K),V(I,J,K),W(I,J,K),P(I,J,K)
182		FORMAT(TR1,D16.9,TR1,D16.9,TR1,D16.9)
183		FORMAT(TR1,D16.9,TR1,D16.9,TR1,D16.9,TR1,D16.9)
    	ENDDO
	    ENDDO
	    ENDDO
    CLOSE(16+RANK)
