...
!	ENDIF
	...
	EDDY_DIFFUS(IS:IE,JS:JE,KS:KE) = C_AVG*FILT_WID(IS:IE,JS:JE,KS:KE)**2*MAGNITUDE_LSS(IS:IE,JS:JE,KS:KE)
	...
	DO I=IS1,IE1
		...
		SGS_T(I,J,K) = 0.5D0*(	&
		+ XIX(I,J,K)*(-2.D0*EDDY_DIFFUS(I+1,J,K)*DTDX(I+1,J,K) +2.D0*EDDY_DIFFUS(I-1,J,K)*DTDX(I-1,J,K))	&
		+ ETX(I,J,K)*(-2.D0*EDDY_DIFFUS(I,J+1,K)*DTDX(I,J+1,K) +2.D0*EDDY_DIFFUS(I,J-1,K)*DTDX(I,J-1,K))	&
		+ ZTX(I,J,K)*(-2.D0*EDDY_DIFFUS(I,J,K+1)*DTDX(I,J,K+1) +2.D0*EDDY_DIFFUS(I,J,K-1)*DTDX(I,J,K-1))	&

		+ XIY(I,J,K)*(-2.D0*EDDY_DIFFUS(I+1,J,K)*DTDY(I+1,J,K) +2.D0*EDDY_DIFFUS(I-1,J,K)*DTDY(I-1,J,K))	&
		+ ETY(I,J,K)*(-2.D0*EDDY_DIFFUS(I,J+1,K)*DTDY(I,J+1,K) +2.D0*EDDY_DIFFUS(I,J-1,K)*DTDY(I,J-1,K))	&
		+ ZTY(I,J,K)*(-2.D0*EDDY_DIFFUS(I,J,K+1)*DTDY(I,J,K+1) +2.D0*EDDY_DIFFUS(I,J,K-1)*DTDY(I,J,K-1))	&
					
		+ XIZ(I,J,K)*(-2.D0*EDDY_DIFFUS(I+1,J,K)*DTDZ(I+1,J,K) +2.D0*EDDY_DIFFUS(I-1,J,K)*DTDZ(I-1,J,K))	&
		+ ETZ(I,J,K)*(-2.D0*EDDY_DIFFUS(I,J+1,K)*DTDZ(I,J+1,K) +2.D0*EDDY_DIFFUS(I,J-1,K)*DTDZ(I,J-1,K))	&
		+ ZTZ(I,J,K)*(-2.D0*EDDY_DIFFUS(I,J,K+1)*DTDZ(I,J,K+1) +2.D0*EDDY_DIFFUS(I,J,K-1)*DTDZ(I,J,K-1))	)
