	...
	WRITE(CONTOUR(1:4),'(I4.4)') INT(NUM_WRITE)
...
!						+W(I,J,K-1)+W(I,J-1,K-1)+W(I-1,J,K-1)+W(I-1,J-1,K-1))
	...
	WRITE(1000+RANK,*) 'variables=x,y,z,vorM,lamda'
    WRITE(1000+RANK,136) IE-IS,JE-JS,KE-KS,RTIME
136  FORMAT(TR1,'ZONE T="WHOLE", I=',I6,', j=',I6,', k=',I6,', SOLUTIONTIME=',F10.4)
	DO K=KS1,KE
    DO J=JS1,JE
    DO I=IS1,IE
		WRITE(1000+RANK,141) XG(I,J,K),YG(I,J,K),ZG(I,J,K),DUM_3D(I,J,K),LAMDAG(I,J,K)
141		FORMAT(TR1,D16.9,TR1,D16.9,TR1,D16.9,TR1,D16.9,TR1,D16.9)
	ENDDO
	ENDDO
	ENDDO
	CLOSE(1000+RANK)
	...
	WRITE(1000+RANK,157) 1,JE1-JS1+1,KE1-KS1+1,RTIME
157	FORMAT(TR1,'ZONE T="POST", I=',I6,', j=',I6,', k=',I6,', SOLUTIONTIME=',F10.4)
	DO K=KS1,KE1
	DO J=JS1,JE1
	I=IS1
		WRITE(1000+RANK,162) X(I,J,K),Y(I,J,K),Z(I,J,K),YPLUS(I,J,K)
162		FORMAT(TR1,D16.9,TR1,D16.9,TR1,D16.9,TR1,D16.9)
	ENDDO
	ENDDO
	CLOSE(1000+RANK)
	...
	OPEN(UNIT=16+RANK,FILE=FILENAME2,STATUS='UNKNOWN')
        WRITE(16+RANK,176) RE,PE,DTIME,RTIME,NITER_TIME
176		FORMAT(TR1,D16.9,TR1,D16.9,TR1,D16.9,TR1,D16.9,TR1,I16)
		DO K=KS,KE
		DO J=JS,JE
		DO I=IS,IE
		    WRITE(16+RANK,182) NLX(I,J,K),NLY(I,J,K),NLZ(I,J,K),ADV(I,J,K)
	    	WRITE(16+RANK,183) U(I,J,K),V(I,J,K),W(I,J,K),P(I,J,K),T(I,J,K)
182		FORMAT(TR1,D16.9,TR1,D16.9,TR1,D16.9,TR1,D16.9)
