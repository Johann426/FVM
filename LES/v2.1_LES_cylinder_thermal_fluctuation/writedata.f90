...
203		FORMAT(TR1,D16.9,TR1,D16.9,TR1,D16.9,TR1,D16.9,TR1,I16)
		DO K=KS,KE
		DO J=JS,JE
		DO I=IS,IE
		    WRITE(16+RANK,209) NLX(I,J,K),NLY(I,J,K),NLZ(I,J,K),ADV(I,J,K)
	    	WRITE(16+RANK,210) U(I,J,K),V(I,J,K),W(I,J,K),P(I,J,K),T(I,J,K)
209		FORMAT(TR1,D16.9,TR1,D16.9,TR1,D16.9,TR1,D16.9)
210		FORMAT(TR1,D16.9,TR1,D16.9,TR1,D16.9,TR1,D16.9,TR1,D16.9)
    	ENDDO
	    ENDDO
	    ENDDO
    CLOSE(16+RANK)
