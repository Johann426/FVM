...
!	WRITE(*,08) RANK,NPRC,JS,JE,KS,KE
!	WRITE(*,09) RANK,COORDS(0),COORDS(1)
!	WRITE(*,10) RANK,NBR_N,NBR_S
!	WRITE(*,11) RANK,NBR_T,NBR_B
!08	FORMAT(TR1,'PROCESSOR',I3,TR1,'OF',I3,TR4,': JMIN =',I4,', JMAX =',I4,', KMIN =',I4,', KMAX =',I4)
!09	FORMAT(TR1,'RANK',I3,TR1,'COORDINATES',I3,TR1,I3)
!10	FORMAT(TR1,'RANK',I3,TR1,'NORTH',I3,TR1,'SOUTH',I3)
!11	FORMAT(TR1,'RANK',I3,TR1,'TOP',I3,TR1,'BOTTOM',I3)
