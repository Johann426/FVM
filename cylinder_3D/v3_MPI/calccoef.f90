...
!   CPB CALCULATION
	...
	CALL MPI_ALLREDUCE(CPB,DUM,1,MPI_DOUBLE_PRECISION,MPI_SUM,MPI_COMM_WORLD,ERR)
...
!-------------------------------------------------------------------------------
	...
	CALL MPI_ALLREDUCE(P_LIFT,CL_P,1,MPI_DOUBLE_PRECISION,MPI_SUM,MPI_COMM_WORLD,ERR)
	CALL MPI_ALLREDUCE(T_DRAG,CD_V,1,MPI_DOUBLE_PRECISION,MPI_SUM,MPI_COMM_WORLD,ERR)
	CALL MPI_ALLREDUCE(T_LIFT,CL_V,1,MPI_DOUBLE_PRECISION,MPI_SUM,MPI_COMM_WORLD,ERR)
