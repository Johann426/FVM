...
!	ENDDO
    ...
    WRITE(1000+RANK,136) IE-IS,JE-JS,KE-KS,RTIME
136  FORMAT(TR1,'ZONE T="WHOLE", I=',I6,', j=',I6,', k=',I6,', SOLUTIONTIME=',F10.4)
	DO K=KS1,KE
    DO J=JS1,JE
    DO I=IS1,IE
		WRITE(1000+RANK,141) XG(I,J,K),YG(I,J,K),ZG(I,J,K),PG(I,J,K),UG(I,J,K),VG(I,J,K),WG(I,J,K),TG(I,J,K)
141		FORMAT(TR1,D16.9,TR1,D16.9,TR1,D16.9,TR1,D16.9,TR1,D16.9,TR1,D16.9,TR1,D16.9,TR1,D16.9)
	ENDDO
	ENDDO
	ENDDO
	CLOSE(1000+RANK)
    ...
    WRITE(100+RANK,159) IE-IS,JE-JS,KE-KS,RTIME
159  FORMAT(TR1,'ZONE T="WHOLE", I=',I6,', j=',I6,', k=',I6,', SOLUTIONTIME=',F10.4)
	DO K=KS1,KE
    DO J=JS1,JE
    DO I=IS1,IE
		WRITE(100+RANK,164) XG(I,J,K),YG(I,J,K),ZG(I,J,K),DUM_3D(I,J,K),LAMDAG(I,J,K)
164		FORMAT(TR1,D16.9,TR1,D16.9,TR1,D16.9,TR1,D16.9,TR1,D16.9)
	ENDDO
	ENDDO
	ENDDO
	CLOSE(100+RANK)
	...
	OPEN(UNIT=16+RANK,FILE=FILENAME2,STATUS='UNKNOWN')
        WRITE(16+RANK,184) RE,PE,DTIME,RTIME,NITER_TIME
184		FORMAT(TR1,D16.9,TR1,D16.9,TR1,D16.9,TR1,D16.9,TR1,I16)
		DO K=KS,KE
		DO J=JS,JE
		DO I=IS,IE
		    WRITE(16+RANK,190) NLX(I,J,K),NLY(I,J,K),NLZ(I,J,K),ADV(I,J,K)
	    	WRITE(16+RANK,191) U(I,J,K),V(I,J,K),W(I,J,K),P(I,J,K),T(I,J,K)
190		FORMAT(TR1,D16.9,TR1,D16.9,TR1,D16.9,TR1,D16.9)
191		FORMAT(TR1,D16.9,TR1,D16.9,TR1,D16.9,TR1,D16.9,TR1,D16.9)
    	ENDDO
	    ENDDO
	    ENDDO
    CLOSE(16+RANK)
