	...
	!   CELL-FAVE VOLUME FLUX NORMAL TO XI-CONSTANT SURFACE
    DO K=KS1,KE1
    DO J=JS1,JE1
    DO I=IS1,IE1-1
    ...
    *(DJAC(I,J+1,K)*ETZ(I,J+1,K)*P(I,J+1,K)-2.D0*DJAC(I,J,K)*ETZ(I,J,K)*P(I,J,K)+DJAC(I,J-1,K)*ETZ(I,J-1,K)*P(I,J-1,K)) &
    ...
    VN(I,J,K) = VN(I,J,K) +0.25D0																						&
    *(																													&
    +2.D0*RE*ETX(I,J+1,K)*DJAC(I,J+1,K)/AP(I,JS1,K)																					&
    *(DJAC(I,JS1+1,K)*ETX(I,JS1+1,K)*P(I,JS1+1,K)-2.D0*DJAC(I,J+1,K)*ETX(I,J+1,K)*P(I,J+1,K)+DJAC(I,J,K)*ETX(I,J,K)*P(I,J,K))	&
    -2.D0*RE*ETX(I,J,K)*DJAC(I,J,K)/AP(I,J,K)																						&
    *(DJAC(I,J+1,K)*ETX(I,J+1,K)*P(I,J+1,K)-2.D0*DJAC(I,J,K)*ETX(I,J,K)*P(I,J,K)+DJAC(I,J-1,K)*ETX(I,J-1,K)*P(I,J-1,K))	&
    +2.D0*RE*ETY(I,J+1,K)*DJAC(I,J+1,K)/AP(I,JS1,K)																					&
    *(DJAC(I,JS1+1,K)*ETY(I,JS1+1,K)*P(I,JS1+1,K)-2.D0*DJAC(I,J+1,K)*ETY(I,J+1,K)*P(I,J+1,K)+DJAC(I,J,K)*ETY(I,J,K)*P(I,J,K))	&
    -2.D0*RE*ETY(I,J,K)*DJAC(I,J,K)/AP(I,J,K)																						&
    *(DJAC(I,J+1,K)*ETY(I,J+1,K)*P(I,J+1,K)-2.D0*DJAC(I,J,K)*ETY(I,J,K)*P(I,J,K)+DJAC(I,J-1,K)*ETY(I,J-1,K)*P(I,J-1,K))	&
    +2.D0*RE*ETZ(I,J+1,K)*DJAC(I,J+1,K)/AP(I,JS1,K)																					&
    *(DJAC(I,JS1+1,K)*ETZ(I,JS1+1,K)*P(I,JS1+1,K)-2.D0*DJAC(I,J+1,K)*ETZ(I,J+1,K)*P(I,J+1,K)+DJAC(I,J,K)*ETZ(I,J,K)*P(I,J,K))	&
    -2.D0*RE*ETZ(I,J,K)*DJAC(I,J,K)/AP(I,J,K)																						&
    *(DJAC(I,J+1,K)*ETZ(I,J+1,K)*P(I,J+1,K)-2.D0*DJAC(I,J,K)*ETZ(I,J,K)*P(I,J,K)+DJAC(I,J-1,K)*ETZ(I,J-1,K)*P(I,J-1,K))	&
    )
    ENDDO
    ...
    *(																													&
    +2.D0*RE*ETX(I,J,K)*DJAC(I,J,K)/AP(I,J,K)																						&
    *(DJAC(I,J+1,K)*ETX(I,J+1,K)*P(I,J+1,K)-2.D0*DJAC(I,J,K)*ETX(I,J,K)*P(I,J,K)+DJAC(I,J-1,K)*ETX(I,J-1,K)*P(I,J-1,K))	&
    -2.D0*RE*ETX(I,J-1,K)*DJAC(I,J-1,K)/AP(I,JE1,K)																					&
    *(DJAC(I,J,K)*ETX(I,J,K)*P(I,J,K)-2.D0*DJAC(I,J-1,K)*ETX(I,J-1,K)*P(I,J-1,K)+DJAC(I,JE1-1,K)*ETX(I,JE1-1,K)*P(I,JE1-1,K))	&
    +2.D0*RE*ETY(I,J,K)*DJAC(I,J,K)/AP(I,J,K)																						&
    *(DJAC(I,J+1,K)*ETY(I,J+1,K)*P(I,J+1,K)-2.D0*DJAC(I,J,K)*ETY(I,J,K)*P(I,J,K)+DJAC(I,J-1,K)*ETY(I,J-1,K)*P(I,J-1,K))	&
    -2.D0*RE*ETY(I,J-1,K)*DJAC(I,J-1,K)/AP(I,JE1,K)																					&
    *(DJAC(I,J,K)*ETY(I,J,K)*P(I,J,K)-2.D0*DJAC(I,J-1,K)*ETY(I,J-1,K)*P(I,J-1,K)+DJAC(I,JE1-1,K)*ETY(I,JE1-1,K)*P(I,JE1-1,K))	&
    +2.D0*RE*ETZ(I,J,K)*DJAC(I,J,K)/AP(I,J,K)																					&
    *(DJAC(I,J+1,K)*ETZ(I,J+1,K)*P(I,J+1,K)-2.D0*DJAC(I,J,K)*ETZ(I,J,K)*P(I,J,K)+DJAC(I,J-1,K)*ETZ(I,J-1,K)*P(I,J-1,K))	&
    -2.D0*RE*ETZ(I,J-1,K)*DJAC(I,J-1,K)/AP(I,JE1,K)																					&
    *(DJAC(I,J,K)*ETZ(I,J,K)*P(I,J,K)-2.D0*DJAC(I,J-1,K)*ETZ(I,J-1,K)*P(I,J-1,K)+DJAC(I,JE1-1,K)*ETZ(I,JE1-1,K)*P(I,JE1-1,K))	&
    )
    ENDDO
    ENDDO
