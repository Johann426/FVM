    ...
    J=JS !branch cut region
        VOR_Z(I,J,K) = VOR_Z(I,JE1,K)
        VOR_Y(I,J,K) = VOR_Y(I,JE1,K)
        VOR_X(I,J,K) = VOR_X(I,JE1,K)
        
    J=JE !branch cut region
        VOR_Z(I,J,K) = VOR_Z(I,JS1,K)
        VOR_Y(I,J,K) = VOR_Z(I,JS1,K)
        VOR_X(I,J,K) = VOR_Z(I,JS1,K)
    ENDDO
    ENDDO
