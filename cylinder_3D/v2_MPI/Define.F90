...
IF(RANK.EQ.0) THEN
	...
	CALL MPI_TYPE_CONTIGUOUS(IE-IS+1,MPI_DOUBLE_PRECISION,PLANE_CONST_K,ERR)
	
	CALL MPI_TYPE_COMMIT(PLANE_CONST_K,ERR)
	
	CALL MPI_BCAST(X(0,0,KS),1,PLANE_CONST_K,0,MPI_COMM_WORLD,ERR)
