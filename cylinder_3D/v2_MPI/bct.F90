...
!	ENDDO
	...
	IF(RANK.EQ.0)		CALL MPI_ISEND(T(I,J,KS1),1,MPI_DOUBLE_PRECISION,NPRC-1,TAG1,MPI_COMM_WORLD,ISEND2,ERR)
	
	IF(RANK.EQ.NPRC-1)	CALL MPI_ISEND(T(I,J,KE1),1,MPI_DOUBLE_PRECISION,0,TAG2,MPI_COMM_WORLD,ISEND1,ERR)

	IF(RANK.EQ.NPRC-1)	CALL MPI_IRECV(T(I,J,KE) ,1,MPI_DOUBLE_PRECISION,0,TAG1,MPI_COMM_WORLD,IRECV2,ERR)
		
	IF(RANK.EQ.0)		CALL MPI_IRECV(T(I,J,KS) ,1,MPI_DOUBLE_PRECISION,NPRC-1,TAG2,MPI_COMM_WORLD,IRECV1,ERR)
