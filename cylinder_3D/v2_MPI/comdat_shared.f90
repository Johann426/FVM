...
!   MPI(Massage Passing Interface) VARIABLES
    ...
    INTEGER :: RANK, NPRC
    INTEGER :: COUNT, ERR
    INTEGER :: PLANE_CONST_K
    INTEGER :: IPRV, INXT, ISEND1, ISEND2, IRECV1, IRECV2
...
!--------------------------------------------------------------------
    ...
    DOUBLE PRECISION :: UG(0:NI,0:NJ,0:NK)
	DOUBLE PRECISION :: VG(0:NI,0:NJ,0:NK)
	DOUBLE PRECISION :: WG(0:NI,0:NJ,0:NK)
