    ...
    *(DJAC(I,J+1,K)*ETZ(I,J+1,K)*P(I,J+1,K)-2.D0*DJAC(I,J,K)*ETZ(I,J,K)*P(I,J,K)+DJAC(I,J-1,K)*ETZ(I,J-1,K)*P(I,J-1,K))	&
    -2.D0*RE*ETZ(I,J-1,K)/AP(I,JE1,K)																					&
