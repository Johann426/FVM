	...
	WRITE(34+RANK,*) 'title=""'
	WRITE(34+RANK,*) 'variables=x,y,z,THETA,J,Q11,Q12,Q13'
	WRITE(34+RANK,*) 'zone t="',RTIME,'",i=',IE-IS+1,',j=',JE-JS+1,',k=',KE-KS+1
	DO K=KS,KE
	DO J=JS,JE
	DO I=IS,IE
		WRITE(34+RANK,*) X(I,J,K),Y(I,J,K),Z(I,J,K),THETA(I,J,K),DJAC(I,J,K),Q11(I,J,K),Q12(I,J,K),Q13(I,J,K)
	ENDDO
	ENDDO
	ENDDO
	CLOSE(34+RANK)
...
!	L3 =DSQRT((XG(I,J+1,K)-XG(I,J,K+1))**2+(YG(I,J+1,K)-YG(I,J,K+1))**2+(ZG(I,J+1,K)-ZG(I,J,K+1))**2)
	...
	CALL MPI_ALLREDUCE(DUM,SUM_AREA,1,MPI_DOUBLE_PRECISION,MPI_SUM,MPI_COMM_WORLD,ERR) ! SUM_AREA = DUM
