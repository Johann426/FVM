	...
	ALLOCATE(VOR_X(IS1:IE,JS1:JE,KS1:KE),STAT=ALLOC_ERR)
	ALLOCATE(VOR_Y(IS1:IE,JS1:JE,KS1:KE),STAT=ALLOC_ERR)
	ALLOCATE(VOR_Z(IS1:IE,JS1:JE,KS1:KE),STAT=ALLOC_ERR)
	...
	WRITE(34+RANK,*) 'title=""'
	WRITE(34+RANK,*) 'variables=x,y,z,THETA'
	WRITE(34+RANK,*) 'zone t="',RTIME,'",i=',IE-IS+1,',j=',JE-JS+1,',k=',KE-KS+1
	DO K=KS,KE
	DO J=JS,JE
	DO I=IS,IE
		WRITE(34+RANK,*) X(I,J,K),Y(I,J,K),Z(I,J,K),THETA(I,J,K)
	ENDDO
	ENDDO
	ENDDO
	CLOSE(34+RANK)
