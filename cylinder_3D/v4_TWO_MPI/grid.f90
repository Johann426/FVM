...
!----------------------------------------------------------------------------	
	...
	CALL MPI_BCAST(XG(1,J,K),NI,MPI_DOUBLE_PRECISION,0,COMM_NEW,ERR)
	
	CALL MPI_BCAST(YG(1,J,K),NI,MPI_DOUBLE_PRECISION,0,COMM_NEW,ERR)
	
	CALL MPI_BCAST(ZG(1,J,K),NI,MPI_DOUBLE_PRECISION,0,COMM_NEW,ERR)
	...
	CALL MPI_BCAST(X(0,J,K),NI+1,MPI_DOUBLE_PRECISION,0,COMM_NEW,ERR)
	
	CALL MPI_BCAST(Y(0,J,K),NI+1,MPI_DOUBLE_PRECISION,0,COMM_NEW,ERR)
	
	CALL MPI_BCAST(Z(0,J,K),NI+1,MPI_DOUBLE_PRECISION,0,COMM_NEW,ERR)
