    ...
    DOUBLE PRECISION :: U_F(0:NI,0:NJ,2:2),V_F(0:NI,0:NJ,2:2)
	DOUBLE PRECISION :: T_F(0:NI,0:NJ,2:2)
...
!--------------------------------------------------------------------
	...
	DOUBLE PRECISION :: DFIX(0:NI,0:NJ,2:2),DFIY(0:NI,0:NJ,2:2)
	DOUBLE PRECISION :: DFEX(0:NI,0:NJ,2:2),DFEY(0:NI,0:NJ,2:2)
    DOUBLE PRECISION :: DFEX_NM1(0:NI,0:NJ,2:2),DFEY_NM1(0:NI,0:NJ,2:2)
    
    DOUBLE PRECISION :: DFIP(0:NI,0:NJ,2:2)
    DOUBLE PRECISION :: DFEP(0:NI,0:NJ,2:2)
    
	DOUBLE PRECISION :: ADV(0:NI,0:NJ,2:2)
	DOUBLE PRECISION :: ADV_NM1(0:NI,0:NJ,2:2)
	
    DOUBLE PRECISION :: DFIT(0:NI,0:NJ,2:2)
    DOUBLE PRECISION :: DFET(0:NI,0:NJ,2:2)
    DOUBLE PRECISION :: DFET_NM1(0:NI,0:NJ,2:2)
...
!---------------------------------------------------------------------------
	...
	DOUBLE PRECISION :: XXI(0:NI,0:NJ,2:2)
	DOUBLE PRECISION :: YXI(0:NI,0:NJ,2:2)
	DOUBLE PRECISION :: XET(0:NI,0:NJ,2:2)
	DOUBLE PRECISION :: YET(0:NI,0:NJ,2:2)
    ...
    DOUBLE PRECISION :: DJACG(1:NI,1:NJ,2:2)

	DOUBLE PRECISION :: XGXI(1:NI,1:NJ,2:2),YGXI(1:NI,1:NJ,2:2)
	DOUBLE PRECISION :: XGET(1:NI,1:NJ,2:2),YGET(1:NI,1:NJ,2:2)

	DOUBLE PRECISION :: XIXG(1:NI,1:NJ,2:2),XIYG(1:NI,1:NJ,2:2)
	DOUBLE PRECISION :: ETXG(1:NI,1:NJ,2:2),ETYG(1:NI,1:NJ,2:2)
!---------------------------------------------------------------------------
