...
!   THE EXPLICIT TERMS : Su
    AP(sx1:ex1,sy1:ey1,2:NKM1) = 2.D0*RE*DJAC(sx1:ex1,sy1:ey1,2:NKM1)/DTIME	&
								+DE(sx1:ex1,sy1:ey1,2:NKM1)					&
								+DW(sx1:ex1,sy1:ey1,2:NKM1)					&
								+DN(sx1:ex1,sy1:ey1,2:NKM1)					&
								+DS(sx1:ex1,sy1:ey1,2:NKM1)
    AE = DE
	AW = DW
	AN = DN
	AS = DS
...
!--- SUMMATION OF EXPLICIT COMPONENTS --------------------------------------
    SU(sx1:ex1,sy1:ey1,2:NKM1)=2.D0*RE*DJAC(sx1:ex1,sy1:ey1,2:NKM1)/DTIME * U_N(sx1:ex1,sy1:ey1,2:NKM1)	&
                - 3.D0*RE*NLX    (sx1:ex1,sy1:ey1,2:NKM1) + 1.D0*RE*NLX_NM1(sx1:ex1,sy1:ey1,2:NKM1)		&
		        +		  DIFX   (sx1:ex1,sy1:ey1,2:NKM1) + 2.D0*RE*S_U(sx1:ex1,sy1:ey1,2:NKM1)			&
