...
!!----------------------------------------------------------------------------
    END SUBROUTINE GRID
!-------------------------------------------------------------------!
!   Exporting data file from gridgen                                !
!                                                                   !
!   style : plot 3D                                                 !
!   format : binary                                                 !
!   precision : double precision                                    !
!                                                                   !
!   GRD file is available for plot3D Loader in tecplot 360.         !
!                                                                   !
!   After reading GRD file by using tecplot 360, write data file as !
!                                                                   !
!   save data file using : ASCII precision 9                        !
!   Zone/Geometry Format : point                                    !
!   Zone : grid                                                     !
!   Variable(s) : selet x,y only                                    !
!                                                                   !
!--------------------------------------------------------------------