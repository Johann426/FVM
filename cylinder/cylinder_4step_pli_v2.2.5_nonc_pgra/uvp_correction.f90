...
!   U-VELOCITY CORRECTION : CONTINUITY CONSTRAINT
	DUM_1(SX1:EX1,SY1:EY1,2:NKM1)=-1.D0																		&
	*( 0.5D0*XIX(SX1:EX1,SY1:EY1,2:NKM1)*(PLI(SX1+1:EX1+1,SY1:EY1,2:NKM1)-PLI(SX1-1:EX1-1,SY1:EY1,2:NKM1))	&
	  +0.5D0*ETX(SX1:EX1,SY1:EY1,2:NKM1)*(PLI(SX1:EX1,SY1+1:EY1+1,2:NKM1)-PLI(SX1:EX1,SY1-1:EY1-1,2:NKM1)))
	U(SX1:EX1,SY1:EY1,2:NKM1) = U(SX1:EX1,SY1:EY1,2:NKM1)+DTIME*DUM_1(SX1:EX1,SY1:EY1,2:NKM1)

!   V-VELOCITY CORRECTION : CONTINUITY CONSTRAINT
	DUM_2(SX1:EX1,SY1:EY1,2:NKM1)=-1.D0																		&
	*( 0.5D0*XIY(SX1:EX1,SY1:EY1,2:NKM1)*(PLI(SX1+1:EX1+1,SY1:EY1,2:NKM1)-PLI(SX1-1:EX1-1,SY1:EY1,2:NKM1))	&
	  +0.5D0*ETY(SX1:EX1,SY1:EY1,2:NKM1)*(PLI(SX1:EX1,SY1+1:EY1+1,2:NKM1)-PLI(SX1:EX1,SY1-1:EY1-1,2:NKM1)))
	V(SX1:EX1,SY1:EY1,2:NKM1)=V(SX1:EX1,SY1:EY1,2:NKM1)+DTIME*DUM_2(SX1:EX1,SY1:EY1,2:NKM1)
!--------------------------------------------------------------------------------------------------------
