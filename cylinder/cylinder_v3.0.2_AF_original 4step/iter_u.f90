...
!   APPROXIMATE FACTORIZATION SOLVER
	...
	+DJAC(SX1+1:EX1+1,SY1:EY1,2:NKM1)*XIX(SX1+1:EX1+1,SY1:EY1,2:NKM1)*ETX(SX1+1:EX1+1,SY1:EY1,2:NKM1)	&
								*(U(SX1+1:EX1+1,SY1+1:EY1+1,2:NKM1)-U(SX1+1:EX1+1,SY1-1:EY1-1,2:NKM1))	&
	-DJAC(SX1-1:EX1-1,SY1:EY1,2:NKM1)*XIX(SX1-1:EX1-1,SY1:EY1,2:NKM1)*ETX(SX1-1:EX1-1,SY1:EY1,2:NKM1)	&
								*(U(SX1-1:EX1-1,SY1+1:EY1+1,2:NKM1)-U(SX1-1:EX1-1,SY1-1:EY1-1,2:NKM1))	&
...
!   MODIFIED : I-SWEEP
    ...
    DO I=SX1,NI-1
        ...
        C(I)=AN(I,J,K)*U(I,J+1,K)+AS(I,J,K)*U(I,J-1,K)  &
...
!----------------------------------------------------------------------------
    ...
    SU(SX1:EX1,SY1:EY1,2:NKM1)=2.D0*RE*DJAC(SX1:EX1,SY1:EY1,2:NKM1)/DTIME*U(SX1:EX1,SY1:EY1,2:NKM1)	&
                              +DD(SX1:EX1,SY1:EY1,2:NKM1)
...
!   MODIFIED : J-SWEEP
    ...
    DO J=SY1,NJ-1
        ...
        C(J)=AE(I,J,K)*U(I+1,J,K)+AW(I,J,K)*U(I-1,J,K)  &
!           +AT(I,J,K)*U(I,J,K+1)+AB(I,J,K)*U(I,J,K-1)	&
            +SU(I,J,K)
        U(I,J,K)=(C(J)-A(J)*U(I,J-1,K))/D(J) ! A(1) SHOULD BE 0(ZERO)
    ENDDO
    DO J=NJ-1,SY1,-1
        U(I,J,K)=U(I,J,K)-B(J)*U(I,J+1,K)
    ENDDO
    ENDDO
    ENDDO
!----------------------------------------------------------------------------
